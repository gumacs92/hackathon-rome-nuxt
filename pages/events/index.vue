    ...
    <div class="px-4 lg:px-28 bg-base bg-cover bg-fixed min-h-screen py-32">
      ...
      <div class="grid grid-cols-2 gap-4 text-sm font-bold  lg:grid-cols-5  lg:gap-16  lg:w-fit lg:mx-auto my-16">
        <div
          ...
          :key="index"
          class="text-center bg-black shadow-box rounded-lg p-9 cursor-pointer"
          :class="{'!bg-primary !shadow-active':selectedCategoryId === category.id}"
      ...
      <div class="w-full mt-10">
        <div v-for="(event,index) in filteredEvents" :key="index" class="rounded-xl flex flex-col lg:flex-row 2xl:px-24 my-10">
  ...
  computed: {
    filteredEvents () {
      return this.events.filter((e) => {
        return !this.selectedCategoryId || e.categoryId === this.selectedCategoryId
      })
    }
  },
  beforeMount () {
